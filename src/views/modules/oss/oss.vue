  ...
  <el-card shadow="never" class="aui-card--fill">
    <div class="mod-oss__oss">
      ...
      <el-table
        ...
        <el-table-column prop="image" :label="$t('oss.image')" header-align="center" align="center">
          <template slot-scope="scope">
            <el-col :span="10" class="login-captcha">
              <img :src="scope.row.url" loading="lazy" style="width: 100px;display:block;margin:0 auto;">
            </el-col>
          </template>
        </el-table-column>
