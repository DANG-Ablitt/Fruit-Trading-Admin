...
t.oss.type2 = '阿里云'
t.oss.type3 = '腾讯云'
t.oss.minio_url = '服务器地址'
t.oss.minio_name = '服务器账号'
t.oss.minio_pass = '服务器密码'
t.oss.minio_bucketName = '存储桶'
...
t.coupon = {}
t.coupon.couponName = '产品名称'
t.coupon.couponPic = '产品品牌'
t.coupon.couponType = '抢购类型'
t.coupon.couponType0 = '预约'
t.coupon.couponTime0 = '预约时间'
t.coupon.couponTime1 = '通知时间'
t.coupon.couponType1 = '秒杀'
t.coupon.couponTime2 = '开始时间'
t.coupon.couponPlatform = '使用平台'
t.coupon.couponImage = '上传大图'
t.coupon.couponPlatform0 = '全部'
t.coupon.couponPlatform1 = '移动'
t.coupon.couponPlatform2 = 'PC'
t.coupon.couponCount = '数量'
t.coupon.couponAmount1 = '优惠价'
t.coupon.couponAmount2 = '原价'
t.coupon.couponMemberLevel = '状态'
t.coupon.couponMemberLevel0 = '未开始'
t.coupon.couponMemberLevel1 = '进行中'
t.coupon.couponMemberLevel2 = '已结束'
t.coupon.couponMemberLevel3 = '异常'
t.coupon.coupondate = '详细数据'
t.coupon.couponDetail = '详细参数'
t.coupon.coupontongji = '统计数据'
